...
{
    $row = getFirstResultForQuery("SELECT ".tableName("album_data.art").", ".tableName("album_data.art_mime").", ".tableName("album_data.album_id").", ".tableName("albums.album_name").
                                  " FROM ".tableName("album_data").", ".tableName("albums")." WHERE ".tableName("albums.album_id")." = ".tableName("album_data.album_id").
                                  " AND ".tableName("album_data.album_id")." = %i", $id);
...
{ 
    $row = getFirstResultForQuery("SELECT ".tableName("songs.filename").", ".tableName("albums.album_name").
             " FROM ".tableName("songs").", ".tableName("albums").
             " WHERE ".tableName("songs.album_id")." = %i AND ".tableName("albums.album_id")." = ".tableName("songs.album_id")." LIMIT 1", $id);
    $data = array(); 
...
{ 
    ...
    $error = "";
    $results = getAllResultsForQuery("SELECT ".tableName("songs.filename").", ".tableName("albums.album_name").
                                     " FROM ".tableName("songs").", ".tableName("albums").
                                     " WHERE ".tableName("songs.album_id")." = %i AND ".tableName("albums.album_id")." = ".tableName("songs.album_id"), $error, $id);
...
{ 
    $options = getFirstResultForQuery("SELECT ".tableName("albums.album_name").", ".tableName("albums.artist_id").", ".tableName("artists.artist_id").", ".tableName("artists.artist_name").
                                      " FROM ".tableName("albums").", ".tableName("artists").
                                      " WHERE ".tableName("albums.album_id")." = %i AND ".tableName("artists.artist_id")." = ".tableName("albums.artist_id"), $id);
