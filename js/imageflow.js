...
function ImageFlow ()
{
	...
	{
		/* Evaluate options */
		var optionsArray = new Array( 'aspectRatio', 'captions', 'imageCursor', 'imagesM', 'ImageFlowID', 'imageFocusM', 'imageFocusMax', 'imagesHeight', 'onClick', 'opacity', 'opacityArray', 'percentLandscape', 'percentOther', 'preloadImages', 'reflections', 'reflectionGET', 'reflectionP', 'reflectionPNG', 'scrollbarP', 'slider', 'sliderCursor', 'sliderWidth', 'startID', 'startAnimation', 'xStep', 'textLoading' );
	...
	this.loadingStatus = function()
	{
		...
		var loadingTxt = document.createTextNode(thisObject.textLoading+' '+completed+'/'+i);
